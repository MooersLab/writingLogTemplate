...
\subsubsection*{Inventory of data on hand}
...
\subsubsection*{Inventory of project's required external software}
...
\subsubsection*{Inventory of project's software repositories}
...
\begin*{table}
    ...
    \begin*{tabular}{cc}
        ...
        \toprule
         ...
         \bottomrule
    \end{tabular}
    \caption*{Project's code repoitokvlk.}
    \label{tab:my_label}
\end{table}
...
\begin*{description}
  ...
  \item [] Citations have entries in the \gls{annotated bibliography}.
...
\subsection*{Protocol for BibTeX to BibLaTeX library conversion}

This protocol requires the R package.
The use of the R IDE Rstudio is optional.
...
\begin{enumerate}
\item Start R-Studio
\item Run the following code after editing the file paths:
\end{enumerate}
