...
% In other words, we are using the writing log as an incubator for the initial drafts of these paper components.
...
% If the work is computational or experimental, there are many plans to get it done. 
...
% Some plans may be specific to the particular project at hand and will need to be elaborated on.
...
% You could always export the Mind map to a PDF or PNG file, and import it as a figure in to the writing log.
