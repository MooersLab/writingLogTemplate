...
\begin{description}
  \item [Date] Central hypothesis identified.
  \item [Date] Introdution drafted.
  \item [Date] Results identified in terms of figures and tables.
  \item [Date] Results ordered with respect to central hypothesis.
  \item [Date] Results outlined to the subsection level.
  \item [Date] Results outlined to the paragraph level.
  \item [Date] Figures have been conceptualized.
  \item [Date] Figures have been drafted.
  \item [Date] Figure legends have been drafted.
  \item [Date] Tables have been conceptualized.
  \item [Date] Tables have been drafted.
  \item [Date] Table legends have been drafted.
  \item [Date] Paragraphs in Results section have been developed.
  \item [Date] Paragraphs in Results section have been checked for presence of concluding sentence.
  \item [Date] Discussion points have been identified.
  \item [Date] Discussion points check for presence in prior publications.
  \item [Date] Discussion paragraphs drafted.
  \item [Date] Discussion concluding sentences checked.
  \item [Date] Discussion subsections ordered by relevance to central hypothesis.
  \item [Date] Citations have been entered.
  \item [Date] Citations have been checked.
  \item [Date] Bibliographic information has been checked.
  \item [Date] Citations have entries in annotated bibliography.
  \item [Date] Abstract drafted. 
  \item [Date] Supplemental materials assembled.
  \item [Date] Needs round 1 of rewriting.
  \item [Date] Needs round 2 of rewriting.
  \item [Date] Ready for reverse outline.
  \item [Date] Ready for round 3 of rewriting.
  \item [Date] Ready for reading by internal reviewer or professional writer for intensive comments.
  \item [Date] Intensive review revisions have been incorporated.
  \item [Date] Penultimate draft ready for reading by internal proofreader.
  \item [Date] Penultimate review revisions have been incorporated. 
\end{descriptiion}
