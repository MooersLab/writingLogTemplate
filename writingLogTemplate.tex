...
You could alternatively create a section at the bottom of the writing log for the purpose of storing this kind of information in a list.
Another approach that I use sometimes is to include such information on lines that have been commented out in the text document near where I want to use that information.
I do have to admit that this approach can become a little unwieldy it if the comments wind up spending many lines.
These notes that you may add might be in the form of what are called permanent notes that they include new insights are plans for for the work.
These thoughts are not directly linked or derived from any particular reference.
Another kind of note is known as a citation or reference note and is directly derived from a specific reference.
These kind of notes will contain the BibTeX citekey.

If you are using the Pomodoro method, you would probably want to commit the last one or two poms to the updating of your knowledge base.
If you have been lagging on doing such updates, you may want to commit four to six Palms to this kind of work.
